...
namespace HotelManagementSystem.Data.Migrations
{
    ...
    [Migration("20250115225303_AutomateInvoice2")]
    partial class AutomateInvoice2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManagementSystem.Models.Booking", b =>
                {
                    b.HasOne("HotelManagementSystem.Models.Guest", "Guests")
                        .WithMany("Bookings")
                        .HasForeignKey("GuestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelManagementSystem.Models.Room", "Rooms")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelManagementSystem.Models.Invoice", b =>
                {
                    b.HasOne("HotelManagementSystem.Models.Booking", "Bookings")
                        .WithMany("Invoices")
